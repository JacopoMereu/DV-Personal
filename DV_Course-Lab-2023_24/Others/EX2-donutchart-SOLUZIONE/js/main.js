...
function main() {
    ...
    // TODO Punto 1
    d3.json("./data/data.json").then(data => render_data(sort_object_by_values(data, true)))
}
...
function render_data(data) {
    ...
    const color = d3.scaleOrdinal()
            ...
            // .range(d3.schemeTableau10) // TODO Punto 2 (2/2)
            .range(rainbow)
