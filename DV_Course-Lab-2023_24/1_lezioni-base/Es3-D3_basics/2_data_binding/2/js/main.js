...
function render_data(data) {
     ...
     * B) e salva il riferimento all'ultimo cerchio in una variabile. (hint: last-child. Maggiori informazioni qui: https://developer.mozilla.org/en-US/docs/Web/CSS/:last-child
